                ...
                {notifications.map(notif => (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {(notif.tipo === 'exame_compartilhado' || notif.mensagem.includes('compartilhou o laudo')) && (
                        <div className="mt-2">
                          <a
                            href={`/exames-compartilhados?token=${notif.referencia_id || ''}`}
                            className="inline-flex items-center gap-1 px-3 py-1 text-[11px] font-bold bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition shadow-xs"
                          >
                            Visualizar Exame
                          </a>
                        </div>
