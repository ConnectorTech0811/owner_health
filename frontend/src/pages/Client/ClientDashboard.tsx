    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fadeIn font-sans">
      ...
      <div className="bg-gradient-to-r from-blue-800 via-blue-700 to-indigo-700 text-white rounded-[2rem] p-6 md:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-2xl md:text-3xl font-black mt-3">Carteirinha Digital de {data?.nome}</h2>
      ...
      {/* CARTEIRINHA DIGITAL + PLANO + FAMÍLIA */}
      <div className="space-y-6">
        <h3 className="text-sm font-bold text-slate-500 uppercase tracking-widest text-center md:text-left">Sua Carteirinha Digital</h3>
